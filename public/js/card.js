var card = (function (r) {
    ...
    return (
        ...
        (t.d = function (r, e, a) {
            t.o(r, e) ||
                Object.defineProperty(r, e, { enumerable: !0, get: a });
        }),
        (t.r = function (r) {
    ...
    function (r, e) {
        (function () {
            ...
            ((e = function (r) {
                ...
                (e.find = function (r, e) {
                    return (
                        (r instanceof NodeList || r instanceof Array) &&
                            (r = r[0]),
    ...
    function (r, e, t) {
        ...
        var l,
            s =
                ((l = []),
                function (r, e) {
                    return (l[r] = e), l.filter(Boolean).join("\n");
                });
        function f(r, e, t, a) {
            var n = t
                ? ""
                ...
                : a.css;
            if (r.styleSheet) r.styleSheet.cssText = s(e, n);
            else {
        ...
        function g(r, e, t) {
            var a = t.css,
                ...
                o = t.sourceMap;
            if (
                (n ? r.setAttribute("media", n) : r.removeAttribute("media"),
                o &&
        ...
        r.exports = function (r, e) {
            ...
            return function (r) {
                if (
                    ...
                    for (var o = c(r, e), p = 0; p < t.length; p++) {
                        var l = d(t[p]);
                        0 === i[l].references &&
                    ...
                    return (
                        ...
                        (t.prototype.attachHandlers = function () {
                            ...
                            return (
                                ...
                                this.options.masks.cardNumber &&
                                    t.push(this.maskCardNumber),
                                ...
                                n.on(
                                    this.$cvcInput,
                                    "focus",
                                    this.handle("flipCard")
                                ),
                                n.on(
                                    this.$cvcInput,
                                    "blur",
                                    this.handle("unflipCard")
                                ),
                                r(this.$nameInput, this.$nameDisplay, {
                                    fill: !1,
                                    filters:
                                        this.validToggler("cardHolderName"),
                                    join: " ",
                                })
                            );
                        }),
                        (t.prototype.handleInitialPlaceholders = function () {
                            var r, e, t, a;
                            for (e in ((a = []),
                            (t = this.options.formSelectors)))
                                t[e],
                                    (r = this["$" + e]) instanceof NodeList &&
                                        (r = r[0]),
                                    n.val(r)
                                        ? (n.trigger(r, "paste"),
                                          a.push(
                        ...
                        (t.prototype.validToggler = function (r) {
                            ...
                            return (
                                "cardExpiry" === r
                                    ...
                                    : "cardNumber" === r
                                    ? (e = function (r) {
                                          return Payment.fns.validateCardNumber(
                                              r
                                          );
                                      })
                                    : "cardHolderName" === r &&
                        ...
                        (t.prototype.handlers = {
                            setCardType: function (r, e) {
                                ...
                                if (
                                    ((t = e.data),
                                    (a = new CustomEvent("card-type-changed", {
                                        detail: e.data,
                                    })),
                                    document.dispatchEvent(a),
                                    !n.hasClass(this.$card, t))
                                )
                                    return (
                                        n.removeClass(
                                            this.$card,
                        ...
                        (e = function (r, e, t, a) {
                            ...
                            for (
                                ...
                                (f = e[i]),
                                    (g = a.fill
                                        ? b + t[i].substring(b.length)
                                        : b || t[i]),
                                    j.push((f.textContent = g));
                            return j;
                        }),
                        (t.prototype.getCardType = function () {
                            return (
                                Payment.fns.cardType(
                                    this.$numberInput[0].value
                                ) || "unknown"
                            );
                        }),
                        t
            ...
            (b = t(8)()),
                ...
                (i = [
                    ...
                    },
                    {
                        type: "maestro",
                        pattern:
                            /^(50|5[6-9]|6007|6220|6304|6703|6708|6759|676[1-3])/,
                        format: c,
    ...
    function (r, e, t) {
        ...
        (f.a = f.type =
            ...
            (f.fn = f.function =
                function (r) {
                    if ("undefined" != typeof window && r === window.alert)
                        return !0;
                    var e = d.call(r);
                    return (
                        "[object Function]" === e ||
